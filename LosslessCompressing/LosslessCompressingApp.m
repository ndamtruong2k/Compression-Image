classdef LosslessCompressingApp < handle
    %
    % Usage:
    %     app.LosslessCompressingApp
    ...
    properties (Constant)
        AppPathBase = {'/LosslessCompressing'};
        AppClass = 'LosslessCompressingApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = LosslessCompressingApp()
        ...
        function startApp(obj)
            ...
            mlock;
            LosslessCompressingApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Compression_Practice1')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Compression_Practice1
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Compression_Practice1').getString, ...
            ...
            if nargout(@Compression_Practice1) == 0
                eval('Compression_Practice1');
            else
                obj.AppHandle = eval('Compression_Practice1');
            end
